...
#============================
%w{mysql mysql-devel git patch gcc make zlib-devel curl-devel openssl openssl-devel gcc-c++ kernel-devel libxml2-devel ImageMagick ImageMagick-devel libxslt libxslt-devel memcached readline-devel modssl}.each do |pkg|
  package pkg
end
